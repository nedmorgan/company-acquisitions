...
export default class CompaniesAddForm extends Component {
    render() {
        return (
            <div className="form-container">
                <form className="new-company-form" onSubmit={this.props.handleNewCompany}>
                    <a onClick={this.props.toggleCompanyForm}><i className="back-icon fas fa-arrow-left"></i></a>
